...
const WritehCalculatedCase = (props) => {
    ...
    return (
        (ExpirementClass === undefined)?
            ...
            </div> : <Dop2 class={ExpirementClass}/>
    );

}
export default WritehCalculatedCase